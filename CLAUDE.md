...
`specs/004-estrategias-sequencia/plan.md` (spec ativa; bases: `specs/003-programas-seed/plan.md`, `specs/002-modelo-dados/plan.md`, `specs/001-fundacao-projeto/plan.md`)
<!-- SPECKIT END -->
