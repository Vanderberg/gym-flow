...
4. Manual (Android e iOS): Configurações → Treino Monstro (2 toques) → Dias da semana → abrir agenda; voltar ao Treino Padrão e conferir estado vazio; iniciar treino, tentar trocar de programa e conferir o bloqueio.
