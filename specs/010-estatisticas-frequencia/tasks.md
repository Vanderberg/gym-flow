...
- [X] T034 Rodar `npm run check` (lint, tipos e testes) e os passos do `quickstart.md` (incluindo a validação manual em Android e iOS com contas à mão e a virada do dia); marcar a spec como `concluída` em `specs/INDEX.md`
